...
/**
 * Educational Callout (Sessions 9, 10 & 11):
 * Express middleware inspects incoming request headers.
 * - protect: Fetches active user by checking user ID passed in headers ('x-user-id' or 'authorization').
 * - authorize: Checks if req.user.role matches allowed roles.
 */
const protect = async (req, res, next) => {
  try {
    ...
    // Clean potential 'Bearer ' prefix if present
