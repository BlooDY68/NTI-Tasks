...
/**
 * Educational Callout (Session 12):
 * Multer parses `multipart/form-data` requests.
 * - diskStorage: Configures dynamic destination directory and custom filename.
 * - fileFilter: Validates image mime types before writing to disk.
 * - limits: Restricts maximum file payload size.
 */
